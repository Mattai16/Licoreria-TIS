...
public class Configuracion extends WsConfigurerAdapter{
    ...
    @Bean(name = "licorerias")
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema licoreriasSchema) {
        DefaultWsdl11Definition wsdl = new DefaultWsdl11Definition();
        wsdl.setPortTypeName("licoreriasPort");        
        wsdl.setLocationUri("/ws");   
        wsdl.setTargetNamespace("https://t4is.uv.mx/licorerias");        
        wsdl.setSchema(licoreriasSchema);
        return wsdl;
    }
}